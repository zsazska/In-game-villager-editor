...
data modify storage minecraft:trademod SelectedTrades prepend from storage minecraft:trademod SelectedTrades[-1]

data remove storage minecraft:trademod SelectedTrades[-1]

scoreboard players remove selected trademodify 1
